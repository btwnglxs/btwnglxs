...
- Практикуюсь в пентесте на лабораторных ВМ и CTF.
- Изучаю offensive security и эксплуатацию уязвимостей.
- Пишу отчёты и технический анализ атак.
- Пишу скрипты для автоматизации задач составления поверхности атаки на целевую систему и под специфику конкретной цели для нестандартных сценариев.

## Навыки

<p align="center">
<img src="https://img.shields.io/badge/BurpSuite-Web%20Security-orange?style=flat-square">
